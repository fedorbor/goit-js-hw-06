...
const getUsersWithEyeColor = (users, color) => {
 ...
 return UsersWithEyeColor.map(UserWithEyeColor =>{return UserWithEyeColor.name});
...
const getUsersWithGender = (users, gender) => {
  const UsersWithGender = users.filter(user => {
   ...
   return UsersWithGender.map(UserWithGender =>{return UserWithGender.name});
...
const getUsersWithFriend = (users, friendName) => {
  const UserWithEmail = users.filter(user => {
   ...
   return UserWithEmail.map(UserWithGender =>{return UserWithGender.name});
};
